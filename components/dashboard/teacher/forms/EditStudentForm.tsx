...
export default function EditStudentForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const updateStudentPromise = fetch(`/api/students/${student.id}`, {
        method: "PATCH",
        headers: {
        ...
        if (!res.ok) {
          ...
          throw new Error(
            errorData.error || "Error updating student. Please try again.",
          );
        }
        return res.json();
      });
      ...
      toast.promise(updateStudentPromise, {
        ...
        error: (err) =>
          err.message || "Error updating student. Please try again.",
      });
      ...
      <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="flex flex-col gap-1.5 mt-2">
            ...
            <textarea
              name="internalNotes"
              defaultValue={student.internalNotes}
