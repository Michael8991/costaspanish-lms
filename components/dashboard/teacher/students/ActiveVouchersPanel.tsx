...
export default function ActiveVouchersPanel({
  ...
  const handleRemoveVoucher = async (
    ...
    try {
      ...
      toast.success("Bono borrado con exito.");
      // router.refresh();
      ...
      if (error instanceof Error) {
        ...
        toast.error("Ocurrió un error inesperado al borrar el bono.");
      }
    } finally {
            ...
            .map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex w-full items-center justify-end mt-3 gap-2">
                    <button
